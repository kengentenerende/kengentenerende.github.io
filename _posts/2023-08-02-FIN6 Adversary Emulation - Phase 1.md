...
A script for automation was developed to handle the majority of adversary emulation tasks. You can find this script in the corresponding GitHub repository [**GitHub repository**](https://github.com/kengentenerende/Automation-FIN6-Adversary-Emulation) {: .prompt-tip }
